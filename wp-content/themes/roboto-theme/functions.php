...
// Add Advanced Custom Fields Time Picker Add-on
...
if ( function_exists( 'add_image_size' ) ) { 
	add_image_size( 'widescreen-large', 750, 420, true );
	add_image_size( 'widescreen-medium', 500, 280, true );
	add_image_size( 'widescreen-small', 250, 140, true );
	add_image_size( 'cinema-medium', 500, 200, true );
	add_image_size( 'portrait-small', 250, 9999 );

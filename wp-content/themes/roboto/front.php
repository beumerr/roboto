...
$my_query = new WP_Query( $splashargs );
  while ( $my_query->have_posts() ) { 
    $my_query->the_post(); ?>
    <?php $attachment_id = get_field('show_image'); echo wp_get_attachment_image( $attachment_id, full ); ?>
    <div class="date">
      <span class="month">
...
<div class="blurb-news">
  <p class="blurb"><?php the_field( 'front' ); ?></p>
...
<aside class="mail-book">
  <div class="mail">
    <p><?php the_field( 'list_invitation' ); ?>
    <form>
      <input type="email">
